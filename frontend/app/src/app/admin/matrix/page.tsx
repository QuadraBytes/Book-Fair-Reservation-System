            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-2xl md:text-3xl font-semibold tracking-tight flex items-center gap-2">
                        <LayoutGrid className="h-6 w-6" /> Admin Dashboard
                    </h1>
                    <p className="text-sm text-muted-foreground mt-1">
                        Book Fair management overview — stalls, bookings, vendors, revenue & more.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button size="sm" variant="outline" onClick={handleRefresh} disabled={loading}>
                        <CalendarDays className="h-4 w-4 mr-2" /> {loading ? "Refreshing…" : "Refresh"}
                    </Button>
                </div>
            </div>
                ...
                <Card className="rounded-2xl">
                    ...
                    <CardContent className="h-60">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={bookings7d} margin={{ left: 0, right: 0, top: 10, bottom: 0 }}>
                                <defs>
                                ...
                                <Tooltip />
                                <Area type="monotone" dataKey="bookings" stroke="#3b82f6" fill="url(#colorBook)" strokeWidth={2} />
                            </AreaChart>
                        </ResponsiveContainer>
                    </CardContent>
                </Card>
                                ...
                                <tbody>
                                    {recentBookings.map((b) => (
                                        <tr key={b.id} className="border-b last:border-none">
                                            ...
                                            <td className="px-2 py-3 text-right">{formatCurrency(b.amount)}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
